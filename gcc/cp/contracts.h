...
extern bool contracts_any_deferred_p		(tree);
extern void match_deferred_contracts		(tree);
extern tree contracts_deferred_for_decl		(tree);
extern void contracts_update_decl		(tree);
extern void contracts_diagnose_re_decl		(tree, tree);
